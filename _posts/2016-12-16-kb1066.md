...
2. In enginesettings.list you need to put the following text somewhere in the end:
`<LogRequestCountersOnExit>true</LogRequestCountersOnExit>`
<br>This setting works for all backup versions, but starting from Backup 5.4 you can use the following setting:
