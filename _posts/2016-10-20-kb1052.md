...
category: seeding
related: [
  "Seeding data via CloudBerry Backup part II"
]
category: seeding
---
## Problem
...
Notice that we only have 7 files in the “Docs” folder. Now let’s get back to that very folder on the “Slow PC”, add a file to it and do the same process again. As you see on the screenshot below, a file named “BRAND NEW FILE” was added.
